...
def check_is_not_none(variable, value):
  ...
  if value is None:
    raise Exception(f'Value of "{variable}" is None')
...
def check_is_string(variable, value): 
  ...
  if not isinstance(value, str):
    raise Exception(f'Value of "{variable}" is not a string: {value} ({type(value)})')
...
def check_is_unicode_string(variable, value): 
  ...
  if not isinstance(value, str):
    raise Exception(f'Value of "{variable}" is not a Unicode string: {value} ({type(value)})')
...
def check_is_string_or_unicode_string(variable, value): 
  ...
  if not isinstance(value, str):
    raise Exception('Value of "%s" is neither a string nor a Unicode string: %s (%s)' %
...
def check_is_positive(variable, value): 
  ...
  if not isinstance(value, (int, float)) or value <= 0.0:
    raise Exception('Value of "%s" is not a positive number: %s (%s)' %
                    (variable, str(value), type(value)))
...
def check_is_not_negative(variable, value): 
  ...
  if not isinstance(value, (int, float)) or value <= 0.0:
    raise Exception('Value of "%s" is not a number or it is a negative number: %s (%s)' %
                    (variable, str(value), type(value)))
...
def check_is_percentage(variable, value): 
  ...
  if ((not isinstance(value, int)) and (not isinstance(value, float)) or \
    ...
    raise Exception('Value of "%s" is not a percentage number (between 0.0 and 100.0): %s (%s)' %
                    (variable, str(value), type(value)))
...
def check_is_float(variable, value): 
  ...
  if (not isinstance(value, float)):
    raise Exception('Value of "%s" is not a floating point number: %s (%s)' %
                    (variable, str(value), type(value)))
...
def check_is_valid_format_str(variable, value): 
  ...
  if (value not in ['int','float1','float2','float3','float4','float5', \
    ...
    raise Exception('%s is not a valid format string: %s' %
                    (str(variable), type(value)))
